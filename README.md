...
The Vungle iOS SDK can also be installed via [Cocoapods](https://cocoapods.org/).  The latest information around our Cocoapods support can be found at the [VungleSDK-iOS Cocoapods Page](https://cocoapods.org/pods/VungleSDK-iOS)
